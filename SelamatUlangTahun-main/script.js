...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Apr 29, 2025 00:00:00').getTime(),
...
new TypeIt("#teks2", {
  strings: ["Semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, Semoga kamu sukses selalu.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
